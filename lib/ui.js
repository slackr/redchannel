...
class RedChannelUI extends RedChannelObject {
    ...
    show_agents() {
        ...
        Object.keys(this.redchannel.agents).forEach((a) => {
            ...
            rows.push([chalk.blue(ao.ident), ao.ip, chalk.greenBright(agent_secret), new Date(ao.lastseen * 1000).toLocaleString()]);
        });
        ...
        if (this.redchannel.agent.interact) {
            ...
            switch (command) {
                ...
                case "set":
                    ...
                    if (typeof command_help.validate_regex == "object" && typeof command_help.validate_regex.test == "function" && !command_help.validate_regex.test(p)) {
